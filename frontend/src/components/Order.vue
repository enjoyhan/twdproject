...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="ShopId" v-model="value.shopId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ShopId :  {{value.shopId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="EqpStatus" v-model="value.eqpStatus"/>
          </div>
          <div class="grey--text ml-4" v-else>
            EqpStatus :  {{value.eqpStatus }}
          </div>

          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="EqpNm" v-model="value.eqpNm"/>
          </div>
          <div class="grey--text ml-4" v-else>
            EqpNm :  {{value.eqpNm }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="EqpSernum" v-model="value.eqpSernum"/>
          </div>
          <div class="grey--text ml-4" v-else>
            EqpSernum :  {{value.eqpSernum }}
          </div>
